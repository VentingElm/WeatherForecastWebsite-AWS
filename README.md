UPDATE: source.unsplash does not work so background images are now taken from "PicSum photos", an open-source alternative to source.unsplash
...
**`rgb(R,G,B)`_[The Website](https://aws-weatherforecast2.s3-website-us-east-1.amazonaws.com/)_**
